...
console.log(`Por favor, preencha o cartão de visitas a seguir.`)
nome = readlineSync.question(`Qual o seu nome?`)
profissao = readlineSync.question(`Qual a sua profissão atualmente?`)
cidade = readlineSync.question(`Qual a cidade que voce esta morando?`)
email = readlineSync.question(`Qual o seu email?`)
telefone = readlineSync.question(`Qual o seu telefone?`)
anoExperiencia = readlineSync.question(`Quantos anos de experiencia voce tem?`)
disponivelParaFreelance = readlineSync.keyInYN(`Voce esta disponivel para trabalhar como Freelance?`)
console.log(`// ============================================
| CARTÃO DE VISITAS |
============================================
| Nome : ${nome} |
...
| Freelance : ${disponivelParaFreelance ? `sim` : `não`} |
============================================`)
...
// → Seu código aqui:
const materias = ["matematica", "portugues", "ingles", "fisica", "espanhol"]
...
console.log(cidadesBrasil.indexOf("Recife")) // O retorno -1 significa que o item não existe,
// ja que os índices começam em 0 (-1 não está dentro de nenhuma array).
...
const cidadesDoMeio = todasAsCidades.slice(2,7)
...
console.log(todosOsAlunos.length)// Os valores são diferentes pois em "grupos" os nomes ainda estão 
//agrupados em 3 grupos(por isso o valor de 3), sendo que cada um desses grupos contabiliza 1 
//na hora de exibir o valor. No caso de "todosOsAlunos", como foi usado o flat, os grupos foram desfeitos,
//fazendo com que todos os alunos ficassem no mesmo array, assim contabilizando 1 por cada aluno
//(totalizando 8)
console.log("_______________________________");
...
listaFuncionarios[0].cargo = "Programador Senior"
const funcionario4 = {
    nome: "Robison",
    cargo: "Cozinheiro",
    salario: 2700,
...
const loja = {
    ...
    cnpj: "12345678901234",
    endereco: {
        rua: "Aldenildo Vasconselos",
        numero: 832,
        cidade: "Joinville",
        estado: "Santa Catarina"}, 
    categoriasProdutos: ["Frutas", "Alimentos", "Bebidas"
    ],
    aberto: true
}
...
console.log(`A loja ${loja.nomeLoja} fica em ${loja.endereco.cidade} - ${loja.endereco.estado} e está aberta: ${loja.aberto}.`)
loja.categoriasProdutos.push("Higiene")
...
escola.turmas[0].alunos.aluno3 = "Cleverson"
...
//
// → Seu código aqui:
const nomeBiblioteca = readlineSync.question(`Nome da Biblioteca:`)
const anoDeFundacao = readlineSync.questionInt(`Ano de Fundacao:`)
const capacidadeLivros = readlineSync.questionInt(`Capacidade de Livros:`)
const bibliotecaAberta = readlineSync.keyInYN(`A biblioteca está aberta?`)
console.log(`Está é a biblioteca ${nomeBiblioteca}, que foi fundada no ano de ${anoDeFundacao}.\n
Ela possui capacidade para ${capacidadeLivros} livros e ${bibliotecaAberta ? "está" : "não está"} aberta no momento.`)
console.log("_______________________________");
const acervo = [
    livro1 = {
        titulo: "O rapaz",
...
const secoes = ["Ficção", "Ciências", "História", "Infantil"]
...
// - Título e autor de CADA livro do acervo (um livro por linha)
console.log(`Está é a biblioteca ${nomeBiblioteca}, que foi fundada no ano de ${anoDeFundacao}.\n
Ela possui ${acervo.length} livros no acervo e um total de ${secoes.length} secões\n
Os livros que voce pode encontrar nela são: ${acervo[0].titulo} de autoria de ${acervo[0].autor},\n
 ${acervo[1].titulo} de autoria de ${acervo[1].autor},
 \n ${acervo[2].titulo} de autoria de ${acervo[2].autor}, ${acervo[3].titulo} de autoria de ${acervo[3].autor}`)
console.log("_______________________________");
