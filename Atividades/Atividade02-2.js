...
aluno.habilidades = ["veloz", "forte", "inteligente"]
...
const listaDeAlunos = [
    {nome: "Patricio", idade: 17, notas : [6, 8, 7] }, 
    {nome: "Benicio", idade: 18, notas : [9,10,8]},
    {nome: "Fabricio", idade: 17, notas : [6,7,10]}
]
