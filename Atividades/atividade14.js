...
//             idade: rs.questionInt(`Qual a sua idade? : `),
//             cidade: rs.question(`Qual a sua cidade? : `)
//         }
//     )
// }
...
//     Idade : ${usuarios[0].nome}
//     Cidade : ${usuarios[0].cidade}
//     `)
// }
// for(let i = 0 ; i < 2 ; i++) {
//     meusDados()
...
//     let C = rs.questionInt(`Digite uma tempertura em Celsius(apenas o numero, sem a simbologia) : `)
//     console.log(`Calcula em Fahrenheit: F = ${C}°C * 1.8 + 32. --> ${(C*1.8+32).toFixed()}°F`)
// }
// for(let i = 0;i < 3; i++) {
