...
// }
// const pessoa3 = {
//     nome: lerTeclado.question(`Nome da pessoa 3:`),
//     idade: lerTeclado.questionInt(`Idade da pessoa 3:`)
// }
// const pessoas = [pessoa1, pessoa2, pessoa3]
// console.table(pessoas)
// const resultado1 = pessoas[0].idade > pessoas[1].idade
// const resultado2 = pessoas[1].idade < pessoas[2].idade
// const resultado3 = pessoas[0].idade == pessoas[2].idade
// const resultado4 = pessoas[0].idade >= 18
// const resultado5 = pessoas[1].idade >= 18
// const resultado6 = pessoas[2].idade >= 18
// console.log(`
// ${pessoas[0].nome} é mais velho que ${pessoas[1].nome}? : ${resultado1}
// ${pessoas[1].nome} é mais novo que ${pessoas[2].nome}? : ${resultado2}
// ${pessoas[0].nome} tem a mesma idade que ${pessoas[1].nome}? : ${resultado3}
// ${pessoas[0].nome} é maior de idade? : ${resultado4}
// ${pessoas[1].nome} é maior de idade? : ${resultado5}
// ${pessoas[2].nome} é maior de idade? : ${resultado6}
// `)
