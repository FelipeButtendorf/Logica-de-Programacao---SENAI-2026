...
turma.aluno1.notas.push(lerTeclado.questionInt(`João, Nota 1;`))
turma.aluno1.notas.push(lerTeclado.questionInt(`João, Nota 2;`))
turma.aluno1.notas.push(lerTeclado.questionInt(`João, Nota 3;`))
turma.aluno2.notas.push(lerTeclado.questionInt(`Maria, Nota 1;`))
turma.aluno2.notas.push(lerTeclado.questionInt(`Maria, Nota 2;`))
turma.aluno2.notas.push(lerTeclado.questionInt(`Maria, Nota 3;`))
turma.aluno3.notas.push(lerTeclado.questionInt(`Pedro, Nota 1;`))
turma.aluno3.notas.push(lerTeclado.questionInt(`Pedro, Nota 2;`))
turma.aluno3.notas.push(lerTeclado.questionInt(`Pedro, Nota 3;`))
