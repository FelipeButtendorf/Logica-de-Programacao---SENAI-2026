...
`);
if (nomeViajante === "") {
  console.log(`O espaço para o nome está em vazio.
...
====================
Idade do viajante:`);
if (idadeViajante < 18 || idadeViajante >= 150) {
  console.log(`A idade que voce digitou não é válida em nosso site.
    Por favor verifique se o número que você digitou está correto e tente novamente.`);
  process.exit();
}
console.log(`
==============
...
// REVIEW DA REVIEW:
// Todas os erros que ele citou estavam presentes no código.
// As alterações feitas foram as seguintes:
// Verificação de segurança após o input do nome: Usei if/else para verificar se o nomeViajante era igual a ""(string vazia). Caso fosse verdadeiro será exibido uma mensagem de erro e o código sera encerrado com process.exit().
// Verificação de segurança após o input de idade: Usei if/else para verificar se a idadeViajante era menor que 18 ou maior ou igual a 150 para estabelecer um limite minimo e maximo de idade, tambem nao podendo colocar idade negativa. Caso fosse verdadeiro será exibido uma mensagem de erro e o código sera encerrado com process.exit().
